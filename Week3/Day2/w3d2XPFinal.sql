...
select * from film;
select rental_rate, film_id, title, description, release_year from film order by rental_rate asc;
...
select film_id, title, description, rental_rate from film where title = 'Jaws';
