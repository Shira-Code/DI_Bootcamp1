...
// const hilariousGifUrl = 'https://api.giphy.com/v1/gifs/search?q=hilarious&rating=g&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My';

// async function fetchHilariousGifs() {
//     try {
//         const response = await fetch(hilariousGifUrl);
...
// const sunGifUrl = 'https://api.giphy.com/v1/gifs/search?q=sun&limit=10&offset=2&rating=g&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My';

// async function fetchSunGifs() {
//     try {
//         const response = await fetch(sunGifUrl);
